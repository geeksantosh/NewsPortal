...
$categoryid=mysqli_real_escape_string($_POST['category']);
$subcatname=mysqli_real_escape_string($_POST['subcategory']);
$subcatdescription=mysqli_real_escape_string($_POST['sucatdescription']);
...
<html lang="en">
    <head>
        ...
        <title>ElightTechnical | Edit Sub Category</title>
