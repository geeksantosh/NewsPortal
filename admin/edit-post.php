...
{
$posttitle=mysqli_real_escape_string($_POST['posttitle']);
$catid=mysqli_real_escape_string($_POST['category']);
$subcatid=mysqli_real_escape_string($_POST['subcategory']);
$postdetails=mysqli_real_escape_string($_POST['postdescription']);
...
<html lang="en">
    ...
    <meta name="author" content="Santosh Adhikari">
        ...
        <title>ElightTechnical | Add Post</title>
...
<strong>Ooops! </strong> <?php echo htmlentities($error);?></div>
<?php } ?>
